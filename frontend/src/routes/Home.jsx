...
import {
  Flex, Container, Image, Text, Stack, Center, VStack, Box,
...
function Home() {
  return (
    <Container minHeight="100vh" minWidth="100vw" backgroundImage={background} backgroundSize="cover">
      <Flex flexWrap="wrap" height="100vh" alignItems="center">
        ...
        <Center width={{ base: '100%', lg: '50%' }} display="flex" flexDirection="row" justifyContent={{ base: 'center', xl: 'flex-start' }} mb="36vh">
          <VStack>
            <Container position="relative">
              <Image src={prontoAILogo} position="absolute" width="70px" left="30px" top="10px" borderRadius="40px" />
            </Container>

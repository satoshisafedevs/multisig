...
import {
  Button, Input, Flex, Center, Text, Spinner, Box,
...
function PhoneSignIn() {
  const {
    onPinChange, buttonSpinner, validNumber, phone,
    onPhoneChange, signInStatus, confirmationNumber, signInSubmit,
    resetState, errorMsg, pin,
  } = usePhoneLogin();
...
function ActionButton({ signInSubmit }) {
  return <Button colorScheme="orange" onClick={() => signInSubmit()}>Text me</Button>;
}

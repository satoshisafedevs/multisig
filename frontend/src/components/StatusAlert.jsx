...
import {
  Alert, AlertIcon, AlertTitle, Box, AlertDescription,
  CloseButton, Center, Image, Text, Code, HStack,
...
export default function StatusAlert({ signInStatus, resetFlow, errorMsg }) {
  ...
  return (
    <Center m={10}>
      <Alert status={status}>
        {status === 'success' ? <Image src={boratSuccess} objectFit="cover" width="100px" mr="10px" /> : <AlertIcon />}
        <HStack>
          <Box>

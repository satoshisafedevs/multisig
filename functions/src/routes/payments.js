const stripe = require("stripe")(
    "sk_test_51P1AO404FMgnp5BUQ48kHHdaOwzYHf1co8Yam2s9vK1kQBuVZJ4sx0kcOzBo5XfzxvdvcwJzAxtUWSw9TceMA3Yp00y3paaLad",
);
...
const updateFirestoreSubscription = async (teamId, updateData) => {
    const subscriptionQuerySnapshot = await db
        ...
        .set(
            {
                ...
                paidAt: Timestamp.fromDate(moment(
                    invoiceData.created * 1000).toDate()), // Convert Stripe's timestamp to Firestore Timestamp
...
exports.getPaymentLink = onCall(async (req, res) => {
    if (!req.auth) {
...
exports.stripeWebhook = onRequest(async (req, res) => {
    const endpointSecret = "whsec_KpZSjktrn9kinsBEdAdXo6I9MW692e4R";
